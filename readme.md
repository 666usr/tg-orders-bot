...
## Запуск круглосуточно (деплой на сервер)

Чтобы бот работал 24/7 и не зависел от компьютера, его ставят на сервер (Ubuntu). Готовые файлы — в папке [`deploy/`](deploy/):
